...
public abstract class CircularMold extends Mold {
     ...
     */
    public CircularMold(int initialGrowth, int growthRate, int minimumGrowth, double propagationRate, Entities entityType, double ageDeathFactor, double ageDeathMax) {
